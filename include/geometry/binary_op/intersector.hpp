...
struct Intersector : std::pair<Geometry1, Geometry2> {
...
template <typename Geometry1, typename Geometry2>
constexpr auto make_intersector(Geometry1 &&geometry_1, Geometry2 &&geometry_2) {
    return Intersector<Geometry1, Geometry2>(std::forward<Geometry1>(geometry_1), std::forward<Geometry2>(geometry_2));
}
